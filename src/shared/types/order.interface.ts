...
export type OrderStatus = 'PENDING' | 'PAID' | 'IN_PROCESS' | 'COMPLETED' | 'CANCELED'
export type OrderType = 'AUTO' | 'MANUAL'
export type ManualStatus = 'PENDING' | 'ASSIGNED' | 'AWAITING_2FA' | 'IN_PROGRESS' | 'COMPLETED' | 'FAILED'
export type DonateHubStatus = 'SUCCESS' | 'FAILED' | 'IN_QUEUE' | 'PROGRESS' | 'WAIT'
export type PaymentMethod = 'bank_card' | 'sbp' | 'sberbank' | 'tinkoff_bank'
